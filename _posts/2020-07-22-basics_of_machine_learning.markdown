...
img: mlTheme.png # Add image post (optional)
...
<p align="justify"> In loose terms, ML can help with <i>classification</i>, <i>clustering</i>, and <i>regression</i> for the data to come up with meaningful patterns. </p>
...
<p align="justify"> Again, if we want to view data, we can click on the "eye" icon next to the file name. The initial data points in the <i>train</i> data look as below. </p>
...
<p align="justify"> The output of the above execution is a <i> zip archive </i> that shall subsequently be used for making predictions on the test data. </p>
