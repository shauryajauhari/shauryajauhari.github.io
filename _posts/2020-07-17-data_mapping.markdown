...
<p> These were generic indices. Now for our scenario, we would like to have the bowtie2-indexer installed. It's search term for the tool shed is <i><b> data_manager_bowtie2_index_builder </b></i>. Let's us examine if that worked. </p>
